...
[![My Skills](https://skillicons.dev/icons?i=python,django,flask,fastapi,html,css,js,bootstrap,markdown,sqlite,postgres,redis,docker,git,github,linux,postman)](https://skillicons.dev)
